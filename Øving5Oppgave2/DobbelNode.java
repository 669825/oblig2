package Øving5Oppgave2;
	...
	public class DobbelNode<T> {
		...
		/******************************************************************
		 * Returnerer en referanse til etterf�lgeren av denne noden, eller null hvis
		 * denne er siste.
		 ******************************************************************/
		...
		/*************************************************************************
		 * Returnerer forgjengeren til denne noden, eller null hvis denne er f�rste
		 **************************************************************************/
		...
		/******************************************************************
		 * Settter ny forrige til � peke p� dnode.
		 ******************************************************************/
